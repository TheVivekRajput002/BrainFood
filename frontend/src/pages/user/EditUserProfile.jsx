...
function EditProfile() {
    ...
    const [bio, setBio] = useState('plus ultra !')
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[320px_minmax(0,1fr)] gap-7">
                    <aside className="rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface)] p-5 h-fit">
                        ...
                        <div className="mt-7 space-y-2">
                            ...
                            <button className="w-full h-12 rounded-xl text-left px-4 font-medium text-[var(--color-text-secondary)] hover:bg-[var(--color-hover)] transition-colors">Close Friends</button>
                    ...
                    <section className="w-full max-w-[760px]">
                        ...
                        <div className="mt-8">
                            <label className="text-3xl font-semibold">Website</label>
                            <input
                                type="text"
                                placeholder="Website"
                                className="mt-3 h-12 w-full rounded-2xl border border-[var(--color-input-border)] bg-[var(--color-input-bg)] px-4 text-lg placeholder:text-[var(--color-text-placeholder)] focus:outline-none focus:ring-2 focus:ring-[var(--color-focus-ring)] focus:border-[var(--color-input-focus)]"
                            />
                            <p className="mt-2 text-[var(--color-text-muted)]">
                                Editing your links is only available on mobile. Visit the app to edit your website links.
                            </p>
                        </div>
                        ...
                        <div className="mt-8 rounded-2xl border border-[var(--color-input-border)] bg-[var(--color-input-bg)] p-4 flex items-center justify-between gap-4">
                            <div>
                                <p className="text-2xl font-semibold">Show account suggestions on profiles</p>
                            ...
                            <button
                                ...
                                className={`w-14 h-8 rounded-full p-1 transition-colors ${suggestionsEnabled ? 'bg-[var(--color-primary)]' : 'bg-[var(--color-border-strong)]'}`}
                            >
                                <span
                                    className={`block h-6 w-6 rounded-full bg-[var(--color-text-on-primary)] transition-transform ${suggestionsEnabled ? 'translate-x-6' : 'translate-x-0'}`}
                                />
                            </button>
                        </div>
                        ...
                        <div className="mt-8 flex justify-end">
                            <button className="h-12 min-w-56 px-8 rounded-2xl bg-[var(--color-primary)] text-[var(--color-text-on-primary)] text-xl font-semibold hover:bg-[var(--color-primary-hover)] transition-colors">
                                Submit
                            </button>
                        </div>
                    </section>
